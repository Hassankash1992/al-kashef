      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 border border-amber-100">
          <div className="mb-6 text-center">
            <h2 className="text-xl sm:text-2xl font-bold text-zinc-900 mb-1">مرحباً بك</h2>
            <p className="text-sm text-zinc-500">أنشئ حساب شركتك للبدء</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="company-slug" className="block text-sm font-semibold text-zinc-800 mb-2">
                رابط الشركة
              </label>
              <div className="flex items-stretch bg-white border-2 border-zinc-200 rounded-xl overflow-hidden focus-within:border-amber-400 focus-within:ring-4 focus-within:ring-amber-100 transition-all" dir="ltr">
                <span className="flex items-center px-3 bg-zinc-50 text-zinc-500 text-xs sm:text-sm border-l border-zinc-200 whitespace-nowrap font-mono select-none">
                  eventface.com/
                </span>
                <input
                  id="company-slug"
                  ...
                  className="flex-1 min-w-0 px-3 py-3 text-sm text-zinc-900 placeholder:text-zinc-400 bg-white focus:outline-none font-mono"
                />
              </div>
              <p className="text-xs text-zinc-500 mt-1.5">يُستخدم في روابط فعالياتك العامة</p>
            </div>
