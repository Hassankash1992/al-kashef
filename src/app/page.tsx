  ...
  const plans = [
    {
      ...
      features: ["10 فعاليات شهرياً", "500 صورة لكل فعالية", "بحث بالوجه (دقة 93%)", "دومين فرعي", "5 GB تخزين", "دعم بالإيميل"],
      highlight: false,
      cta: "ابدأ مجاناً",
    },
    {
      ...
      features: ["50 فعالية شهرياً", "1500 صورة لكل فعالية", "بحث بالوجه فائق (دقة 98%)", "دومين مخصص", "واتساب وتيليجرام", "5 أعضاء فريق", "50 GB تخزين", "دعم أولوية"],
      highlight: true,
      cta: "الأكثر شيوعاً",
      badge: "موصى به",
    },
    {
      ...
      features: ["فعاليات غير محدودة", "صور غير محدودة", "White Label كامل", "بحث بالوجه فائق (دقة 98%)", "أعضاء غير محدودين", "API Access", "تخزين خاص بك", "دعم متقدم 24/7"],
      highlight: false,
      cta: "تواصل معنا",
    },
  ];
